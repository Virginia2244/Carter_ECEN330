...
void testBoards() {
  ...
  board6.squares[MID][MID] = MINIMAX_X_SQUARE;
  ...
  board7.squares[TOP][MID] = MINIMAX_O_SQUARE;
  board7.squares[TOP][RGT] = MINIMAX_EMPTY_SQUARE;
  board7.squares[MID][LFT] = MINIMAX_O_SQUARE;
  board7.squares[MID][MID] = MINIMAX_EMPTY_SQUARE;
  board7.squares[MID][RGT] = MINIMAX_X_SQUARE;
  board7.squares[BOT][LFT] = MINIMAX_EMPTY_SQUARE;
  board7.squares[BOT][MID] = MINIMAX_X_SQUARE;
  ...
  board9.squares[MID][RGT] = MINIMAX_X_SQUARE;
  ...
  board10.squares[MID][RGT] = MINIMAX_X_SQUARE;
  ...
  board11.squares[MID][MID] = MINIMAX_O_SQUARE;
  board11.squares[MID][RGT] = MINIMAX_O_SQUARE;
