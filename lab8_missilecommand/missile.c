...
// Initialize the missile as a player missile.  This function takes an (x,
// y) destination of the missile (where the user touched on the
// touchscreen).  The origin should be the closest "firing location" to the
// destination (there are three firing locations evenly spaced along the
